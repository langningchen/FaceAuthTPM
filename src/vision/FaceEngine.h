...
class FaceEngine {
  public:
    ...
    bool ExtractEmbedding(const cv::Mat& frame, std::vector<float>& embedding,
                          cv::Rect* faceRect = nullptr);
...
bool OpenCamera(cv::VideoCapture& camera, int cameraIndex, int width = 640, int height = 480,
